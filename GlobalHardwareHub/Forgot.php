...
<head>
  ...
  <title>Global Hardware Hub | Forgot Password</title>
  <!-- Font Awesome 6 -->
...
<body>
  ...
  <main class="forgot-section">
    <!-- H. Scroll Reveal - Forgot Card -->
    <div class="forgot-card" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="50">
      <div class="forgot-header" data-aos="fade-up" data-aos-duration="400" data-aos-offset="30">
        <h2><i class="fas fa-key"></i> Forgot Your Password?</h2>
        <p>Enter your registered email address. We will send you a password reset link.</p>
      </div>

      <div id="messageContainer" class="message" data-aos="fade-up" data-aos-duration="300"></div>

      <form id="forgotForm">
        <div class="form-group" data-aos="fade-up" data-aos-duration="400" data-aos-offset="30" data-aos-delay="50">
          <label><i class="fas fa-envelope"></i> Email Address</label>
          <div class="input-wrapper">
            <i class="fas fa-envelope"></i>
            <input type="email" id="emailInput" placeholder="Enter your registered email" autocomplete="email">
          </div>
        </div>

        <button type="submit" class="submit-btn" id="submitBtn" data-aos="fade-up" data-aos-duration="400" data-aos-delay="100">
          <span id="btnText"><i class="fas fa-paper-plane"></i> Send Reset Link</span>
        </button>

        <div class="back-link" data-aos="fade-up" data-aos-duration="300" data-aos-delay="150">
  ...
  <script>
    ...
    function showMessage(text, type) {
      messageContainer.innerHTML = `<i class="fas ${type === 'success' ? 'fa-check-circle' : 'fa-exclamation-circle'}"></i> ${text}`;
    ...
    function setLoading(isLoading) {
      if (isLoading) {
        ...
        btnText.innerHTML = '<i class="fas fa-paper-plane"></i> Send Reset Link';
      }
    }
