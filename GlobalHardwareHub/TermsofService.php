...
<head>
    ...
    <title>Global Hardware Hub | Terms of Service</title>
    <!-- Font Awesome 6 -->
    ...
    <style>
        * {
        ...
        /* C. Sidebar Nav Link Hover Animation */
        .sidebar-nav a {
            text-decoration: none;
            color: #6B7280;
            font-weight: 500;
        ...
        /* Section Cards - White */
        /* A. Terms Section Hover Animation */
        .terms-section {
            background: #FFFFFF;
            border-radius: 32px;
            padding: 1.8rem;
...
<body>
    ...
    <div class="terms-container">
        <div class="breadcrumb">
            <a href="FYPHome.php"><i class="fas fa-home"></i> Home</a> / <span>Terms of Service</span>
        </div>
        <!-- H. Scroll Reveal - Page Title -->
        <h1 class="page-title" data-aos="fade-up" data-aos-duration="600" data-aos-offset="50"><i class="fas fa-file-contract"></i> Terms of Service</h1>
        <div class="last-updated" data-aos="fade-up" data-aos-duration="400" data-aos-offset="30"><i class="fas fa-calendar-alt"></i> Last updated: March 28, 2026</div>
        ...
        <div class="terms-layout">
            ...
            <aside class="sidebar" data-aos="fade-right" data-aos-duration="600" data-aos-offset="100">
                ...
                <ul class="sidebar-nav">
                    <li><a href="#user-responsibilities"><i class="fas fa-user-check"></i> User Responsibilities</a>
                    </li>
                    <li><a href="#vendor-terms"><i class="fas fa-store"></i> Vendor Terms</a></li>
                    <li><a href="#payment-terms"><i class="fas fa-credit-card"></i> Payment Terms</a></li>
                    <li><a href="#dispute-resolution"><i class="fas fa-gavel"></i> Dispute Resolution</a></li>
                </ul>
            </aside>

            <div class="main-content">
                <!-- H. Scroll Reveal - Terms Sections -->
                <section id="user-responsibilities" class="terms-section" data-aos="fade-up" data-aos-duration="500" data-aos-offset="50" data-aos-delay="50">
                    <h2><i class="fas fa-user-check"></i> User Responsibilities</h2>
                    <h3><i class="fas fa-lock"></i> Account Responsibility</h3>
                    <p>You are responsible for maintaining the confidentiality of your account credentials and for all
                        activities that occur under your account. Notify us immediately of any unauthorized use.</p>

                    <h3><i class="fas fa-info-circle"></i> Accurate Information</h3>
                    <p>You agree to provide accurate, current, and complete information when creating an account or
                        making a purchase. False information may result in account suspension.</p>
                    ...
                    <h3><i class="fas fa-hand-peace"></i> Respectful Behavior</h3>
                    <p>All users must maintain respectful communication with vendors, support staff, and other community
                        members. Hate speech, harassment, or abusive behavior will result in immediate account
                        termination.</p>

                    <h3><i class="fas fa-shield-alt"></i> Security Responsibility</h3>
                    <p>You are responsible for securing your own device and network when accessing our platform. Use
                        strong passwords and enable two-factor authentication when available.</p>
                </section>

                <section id="vendor-terms" class="terms-section" data-aos="fade-up" data-aos-duration="500" data-aos-offset="50" data-aos-delay="100">
                    <h2><i class="fas fa-store"></i> Vendor Terms</h2>
                    <h3><i class="fas fa-clipboard-list"></i> Vendor Responsibilities</h3>
                    <p>Vendors are responsible for accurate product listings, timely order fulfillment, and maintaining
                        customer service standards. Failure to meet these standards may affect vendor ratings and
                        account standing.</p>

                    <h3><i class="fas fa-certificate"></i> Product Authenticity</h3>
                    <p>All products listed must be 100% authentic and legally sourced. Counterfeit or unauthorized
                        products will result in immediate removal and account suspension.</p>

                    <h3><i class="fas fa-truck"></i> Shipping Responsibility</h3>
                    <p>Vendors must ship orders within the stated processing time and provide tracking information. Late
                        shipments negatively impact vendor ratings and may result in penalties.</p>

                    <h3><i class="fas fa-file-signature"></i> Warranty Information</h3>
                    <p>Vendors must clearly disclose warranty terms for each product. Manufacturer warranties should be
                        honored, and sellers must facilitate warranty claims when applicable.</p>

                    <h3><i class="fas fa-exclamation-triangle"></i> Account Suspension Conditions</h3>
                    <ul class="bullet-list">
                        <li>Repeated late shipments or cancellations</li>
                        <li>Fake or misleading product listings</li>
                        <li>Poor customer service ratings</li>
                        <li>Violation of prohibited activities</li>
                        <li>Failure to resolve customer disputes</li>
                    </ul>
                </section>

                <section id="payment-terms" class="terms-section" data-aos="fade-up" data-aos-duration="500" data-aos-offset="50" data-aos-delay="150">
                    <h2><i class="fas fa-credit-card"></i> Payment Terms</h2>
                    <h3><i class="fas fa-wallet"></i> Accepted Payment Methods</h3>
                    <p>We accept Visa, MasterCard, American Express, Discover, PayPal, Apple Pay, Google Pay, and bank
                        transfers. All payments are processed through secure, PCI-compliant gateways.</p>

                    <h3><i class="fas fa-lock"></i> Payment Security</h3>
                    <p>Your payment information is encrypted using industry-standard SSL technology. We do not store
                        full credit card details on our servers. All transactions are processed by trusted payment
                        partners.</p>

                    <h3><i class="fas fa-undo-alt"></i> Refund Policy Summary</h3>
                    <p>Refunds are processed within 5-10 business days after return approval. Refunds are issued to the
                        original payment method. For full details, please refer to our <a href="ReturnPolicy.php"
                            style="color:var(--primary); font-weight:600; transition: all 0.2s ease;" onmouseover="this.style.transform='translateX(2px)'" onmouseout="this.style.transform='translateX(0)'">Return & Refund Policy <i
                                class="fas fa-arrow-right"></i></a>.</p>

                    <h3><i class="fas fa-times-circle"></i> Order Cancellation Policy</h3>
                    <ul class="bullet-list">
                        <li>Orders can be cancelled within 1 hour of placement at no charge</li>
                        <li>After processing begins, cancellations may not be possible</li>
                        <li>Vendors may cancel orders if products are out of stock</li>
                        <li>Contact support immediately for cancellation requests</li>
                    </ul>
                </section>

                <section id="dispute-resolution" class="terms-section" data-aos="fade-up" data-aos-duration="500" data-aos-offset="50" data-aos-delay="200">
                    <h2><i class="fas fa-gavel"></i> Dispute Resolution</h2>
                    <h3><i class="fas fa-comments"></i> How Disputes Are Handled</h3>
                    <p>We encourage buyers and vendors to resolve issues directly through our messaging system. If
                        resolution is not possible, Global Hardware Hub support will mediate disputes based on evidence
                        provided.
                    </p>

                    <h3><i class="fas fa-exchange-alt"></i> Refund and Return Disputes</h3>
                    <p>For refund disputes, we review order details, tracking information, and communication between
                        parties. Our team will make a fair determination within 3-5 business days.</p>

                    <h3><i class="fas fa-envelope"></i> Contact Support for Disputes</h3>
                    <p>To file a dispute, contact our support team at <strong>disputes@GlobalHardwareHub.com</strong>
                        with your
                        order number and evidence. All disputes must be submitted within 30 days of order delivery.</p>

                    <h3><i class="fas fa-clock"></i> Resolution Timeframe</h3>
                    <ul class="bullet-list">
                        <li>Initial response: Within 24-48 hours</li>
                        <li>Investigation period: 3-5 business days</li>
                        <li>Final resolution notification: Via email</li>
                        <li>Appeals: May be requested within 7 days of resolution</li>
                    </ul>

                    <div class="info-box">
                        <i class="fas fa-info-circle"></i> <strong>Important:</strong> By using Global Hardware Hub, you
                        agree to these Terms of Service. We reserve
    ...
    <footer class="footer" data-aos="fade-up" data-aos-duration="500" data-aos-offset="50">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <a href="WarrantyInfo.php">Warranty Information</a>
