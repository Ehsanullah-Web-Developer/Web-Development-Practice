...
<head>
    ...
    <title>Global Hardware Hub | Reset Password</title>
    <!-- Font Awesome 6 -->
...
<body>
    ...
    <div class="reset-container">
        <!-- H. Scroll Reveal - Reset Card -->
        <div class="reset-card" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="50">
            <div class="reset-icon" data-aos="fade-up" data-aos-duration="400" data-aos-delay="50"><i class="fas fa-lock"></i></div>
            <h2 data-aos="fade-up" data-aos-duration="400" data-aos-delay="100"><i class="fas fa-key"></i> Reset Your Password</h2>
            <p class="instruction-text" data-aos="fade-up" data-aos-duration="400" data-aos-delay="150">Create a new strong password for your account</p>

            <div id="messageBox" class="message-box" data-aos="fade-up" data-aos-duration="300" data-aos-delay="200"></div>
            ...
            <form id="resetForm">
                ...
                <div class="form-group" data-aos="fade-up" data-aos-duration="400" data-aos-delay="250">
                ...
                <button type="submit" id="submitBtn" class="submit-btn" data-aos="fade-up" data-aos-duration="400" data-aos-delay="300"><i class="fas fa-save"></i> Reset Password</button>
            </form>

            <div class="back-link" data-aos="fade-up" data-aos-duration="300" data-aos-delay="350">
    ...
    <script>
        ...
        function renderMobileMenu() {
            ...
            const menuItems = [
                ...
                { title: "Account", submenu: ["My Account", "Profile", "Orders", "Order Details", "Wishlist", "Address Book", "Payment Methods", "Cart", "Checkout", "Checkout Shipping", "Checkout Payment"], links: ["MyAccount.php", "Profile.php", "UserOrders.php", "OrderDetails.php", "Wishlist.php", "AddressBook.php", "PaymentMethods.php", "Cart.php", "Checkout.php", "CheckoutShipping.php", "CheckoutPayment.php"] },
        ...
        if (!resetToken) {
            ...
            messageBox.innerHTML = "<i class='fas fa-exclamation-triangle'></i> No reset token found. Please request a new password reset link.";
        ...
        resetForm.addEventListener("submit", async function (e) {
            ...
            if (!newPassword) {
                ...
                messageBox.innerHTML = "<i class='fas fa-exclamation-circle'></i> Please enter a new password.";
                messageBox.style.display = "block";
                return;
            }

            if (strength.level < 33) {
                messageBox.className = "message-box error";
                messageBox.innerHTML = "<i class='fas fa-exclamation-circle'></i> Password is too weak. Use at least 6 characters.";
                messageBox.style.display = "block";
                return;
            }
            ...
            if (newPassword !== confirmPassword) {
                messageBox.className = "message-box error";
                messageBox.innerHTML = "<i class='fas fa-times-circle'></i> Passwords do not match. Please try again.";
                messageBox.style.display = "block";
                return;
            }
            ...
            try {
                const response = await fetch('./reset_password.php', {
                    ...
                    body: 'token=' + encodeURIComponent(resetToken) + '&new_password=' + encodeURIComponent(newPassword)
                });
                ...
                if (result.success) {
                    ...
                    messageBox.innerHTML = "<i class='fas fa-check-circle'></i> Password reset successfully! Redirecting to login...";
                    messageBox.style.display = "block";
                ...
                setLoading(false);
                messageBox.className = "message-box error";
                messageBox.innerHTML = "<i class='fas fa-wifi'></i> Something went wrong. Please try again.";
                messageBox.style.display = "block";
